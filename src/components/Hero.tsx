      ...
      <div className="container">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="text-center lg:text-left">
            <p className="text-primary font-semibold text-lg mb-2">JMB ELECTRICAL</p>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-3 mb-8 text-sm">
              ...
              <span className="bg-primary/20 text-primary px-4 py-2 rounded-full">Latest Technology</span>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 bg-green-500 text-white px-8 py-3 rounded font-semibold text-lg hover:bg-green-600 hover:-translate-y-1 hover:shadow-xl transition-all"
              >
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 text-sm text-muted-foreground">
              ...
              <a href="mailto:info@jmbelectrical.co.za" className="hover:text-primary transition-colors">
